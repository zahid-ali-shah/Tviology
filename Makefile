...
REGISTRY ?= docker.pkg.github.com/zahid-ali-shah/tviology
...
tv-shell:	## Run tviology shell
	docker exec -it tviology_web bash

redis-shell:	## Run redis shell
	docker exec -it tviology_redis bash

redis-shell:	## Run mysql shell
	docker exec -it tviology_mysql bash
